...
const variants = {
  base: "flex h-full w-full items-center justify-center rounded-md border border-dashed cursor-pointer",
  image:
    "relative rounded-md flex justify-center items-center flex-col cursor-pointer min-h-0 min-w-0 border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out",
  active: "border-2",
  disabled:
